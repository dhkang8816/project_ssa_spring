...
<body>
	...
	<div>
		<p>
			<strong>사번:</strong> ${member.memberId}
		</p>
		<p>
			<strong>이름:</strong> ${member.name}
		</p>
		<p>
			<strong>부서:</strong> ${member.department}
		</p>
		<p>
		...
		<p>
			<strong>로그인 실패 횟수:</strong> ${member.failCount}
		</p>
		<p>
			<strong>가입일:</strong> ${member.regDate}
		</p>
		<p>
			<strong>최종 로그인:</strong> ${member.lastLongDate}
		</p>
	</div>
	<br>
	...
	<div style="margin-top: 10px;">
		<button type="button"
			onclick="location.href='${pageContext.request.contextPath}/member/modifyForm?memberId=${member.memberId}'">수정</button>
		<button type="button"
			onclick="location.href='${pageContext.request.contextPath}/member/list'">목록으로</button>
	</div>
</body>
</html>
