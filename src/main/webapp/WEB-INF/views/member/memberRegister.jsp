...
<body>
    ...
    <form:form action="${pageContext.request.contextPath}/member/regist" method="post" enctype="multipart/form-data">
        ...
        <div class="profile-upload-wrapper">
            <label style="display: block; margin-bottom: 5px; font-weight: bold;">프로필 사진 등록</label>
            <img id="imagePreview" src="${pageContext.request.contextPath}/resources/images/member/noImage.jpg" 
