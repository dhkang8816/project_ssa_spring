...
<body>
	...
	<form:form modelAttribute="member"
		...
		<!-- 사진 삭제 트리거 신호 히든 필드 -->
		<input type="hidden" name="deleteOldPicture" id="deleteFlag"
			value="false">
		...
		<table border="1">
			<tr>
				<th>사번</th>
				<td><strong>${member.memberId}</strong> <!-- 💡 form:hidden 을 사용하여 memberAttribute 와 정확히 바인딩되도록 통일 -->
					<form:hidden path="memberId" /></td>
			</tr>
			<tr>
				<th>이름</th>
