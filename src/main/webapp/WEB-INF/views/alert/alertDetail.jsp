	...
	<table border="1" style="width: 600px; border-collapse: collapse;">
		...
		<tbody>
			...
			<tr>
				...
				<td style="padding: 8px; white-space: pre-wrap;"><c:out value="${alert.alertMsg}" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td style="padding: 8px;"><fmt:formatDate value="${alert.firstSendTime}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
			</tr>
			<tr>
				<th style="padding: 8px; text-align: left;">경보전송일시</th>
				<td style="padding: 8px;"><fmt:formatDate value="${alert.sendDate}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
			</tr>
		</tbody>
	</table>
