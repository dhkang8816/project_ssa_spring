					...
					<c:forEach var="detection" items="${detectionList}">
						<tr>
							...
							<td style="padding: 8px; font-weight: bold;">
								<c:out value="${detection.animalType}" />
							</td>
							...
							<td style="padding: 8px;">
								...
								<c:choose>
									<c:when test="${detection.actionStatus == '0'}"><span style="color: red; font-weight: bold;">미확인</span></c:when>
									<c:when test="${detection.actionStatus == '1'}"><span style="color: orange; font-weight: bold;">조치중</span></c:when>
									<c:when test="${detection.actionStatus == '2'}"><span style="color: green; font-weight: bold;">조치완료</span></c:when>
