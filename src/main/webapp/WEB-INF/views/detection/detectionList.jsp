    ...
    <div class="panel">
        ...
        <table id="detectionTable" data-csv-export data-csv-filename="detection-list">
            ...
            <tbody>
                    ...
                    <c:otherwise>
                        <c:forEach var="detection" items="${detectionList}">
                            ...
                            <tr style="cursor: pointer;"
                                ...
                                <!-- 7. 조치 상태를 투박한 컬러 텍스트에서 모던 타원형 알약 배지로 전면 치환 -->
                                <td>
                ...
                <!-- 다조건 동적 검색 폼 영역 (a: 객체명, d: 드론ID, s: 조치상태 코드 연동 유지) -->
...
<script>
// 기존 비즈니스 조치 내역 업데이트 성공 알럿 메시지 제어 스크립트 완전 보존
var msg = "${msg}";
