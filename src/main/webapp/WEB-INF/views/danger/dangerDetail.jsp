	...
	<form:form id="dangerForm" method="post">
			...
			<tbody>
				<tr>
					...
					<td style="padding: 5px 10px;"><input type="text"
						name="dangerId" value="${danger.dangerId}" readonly="readonly"
						style="background-color: #eee; width: 250px;" /></td>
				</tr>
				<tr>
					<th style="padding: 5px 10px;">이상 객체 명칭</th>
					<td style="padding: 5px 10px;"><input type="text"
						name="dangerName" value="${danger.dangerName}" required="required"
						style="width: 250px;" /></td>
				</tr>
				<tr>
					<th style="padding: 5px 10px;">마스터 등록 일자</th>
					<td style="padding: 5px 10px;"><input type="text"
						value="<fmt:formatDate value="${danger.dangerDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div>
			...
			<button type="button" onclick="fn_submit('remove')"
				style="background-color: #f44336; color: white;">객체 삭제</button>
